    ...
    Column(
        ...
        Box(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                ...
                Text("3M AGO", fontSize = 9.sp, fontWeight = FontWeight.Bold, fontFamily = FontFamily.Monospace, color = Color.Black)
            }
        }
        ...
        Row(
            ...
            Row(verticalAlignment = Alignment.CenterVertically) {
                Text("🩺", fontSize = 16.sp)
                Spacer(modifier = Modifier.width(8.dp))
                Text("Volunteer or Medic?", fontSize = 14.sp, color = Color.Black)
            }
            Box(
                modifier = Modifier
                    .background(brutalDarkGreen)
        ...
        Box(
            ...
            Row(modifier = Modifier.fillMaxWidth(), horizontalArrangement = Arrangement.SpaceBetween, verticalAlignment = Alignment.CenterVertically) {
                Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.weight(1f)) {
                    ...
                    Text("ANIMALS SAVED", fontSize = 8.sp, fontWeight = FontWeight.Bold, color = Color.Black, letterSpacing = 1.sp)
                }
                ...
                Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.weight(1f)) {
                    ...
                    Text("VOLUNTEER RUN", fontSize = 8.sp, fontWeight = FontWeight.Bold, color = Color.Black, letterSpacing = 1.sp)
                }
                Box(modifier = Modifier.height(24.dp).width(1.dp).background(Color.LightGray))
                Column(horizontalAlignment = Alignment.CenterHorizontally, modifier = Modifier.weight(1f)) {
                    Text("~18 MIN", fontSize = 16.sp, fontWeight = FontWeight.Black, color = brutalRed)
                    Text("AVG RESPONSE", fontSize = 8.sp, fontWeight = FontWeight.Bold, color = Color.Black, letterSpacing = 1.sp)
                }
            }
        }
    }
